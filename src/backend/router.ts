...
export function post(uri: `/${string}`, content: RouteHandler) {
  setSingleRoute("POST", uri, content);
}
export function del(uri: `/${string}`, content: RouteHandler) {
  setSingleRoute("DELETE", uri, content);
}
export function put(uri: `/${string}`, content: RouteHandler) {
  setSingleRoute("PUT", uri, content);
}
export function patch(uri: `/${string}`, content: RouteHandler) {
  setSingleRoute("PATCH", uri, content);
}
export function any(uri: `/${string}`, content: RouteHandler) {
  routes.push({
    uri: uri,
    accepts: {
      POST: true,
